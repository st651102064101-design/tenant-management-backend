...
-- Current real data for reports (updated 2026-01-26)
INSERT INTO reports (type, date, description) VALUES
('monthly', '2026-01-01', 'รายงานการเช่ารายเดือนมกราคม 2026 - ผู้เช่า 5 คน'),
('maintenance', '2026-01-15', 'ซ่อมแซมระบบน้ำ ชั้น 2 - งบประมาณ 2,500 บาท'),
('collection', '2026-01-20', 'สรุปการเก็บค่าเช่า - จำนวน 5 คน เก็บได้ครบ'),
('inspection', '2026-01-22', 'ตรวจสอบสภาพห้องทั้งหมด - ปกติทั้งหมด'),
('incident', '2026-01-26', 'เหตุแจ้งประกาศจากผู้เช่า ห้อง 203 - เสียงรบกวน');